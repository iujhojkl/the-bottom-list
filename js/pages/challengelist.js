        ...
        <main v-else class="page-list">
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <p>Have source audio or clicks/taps in video</p>
                    <p>Recording must show player hit the endwall</p>
                    <p>Do not use secret routes or bug routes</p>
                    <p>Do not use easy modes, unmodified level only</p>
                    <p>Cheat indicator required if using tools like MegaHack</p>
                    <p>Legitimately verified with video or witness</p>
                </div>
            </div>
        </main>
    `,
